package com.a3.vendorapp.activity;
...
import com.a3.vendorapp.fragment.ItemListFragment;
import com.a3.vendorapp.fragment.OrderListFragment;
import com.a3.vendorapp.fragment.ProfileFragment;
import com.a3.vendorapp.helper.NotificationReceiver;
import com.a3.vendorapp.helper.viewModel.OrderViewModel;
...
//                        Log.d(TAG, "orderCollectionLoadDb: order from db: " + order.toString());
    ...
    public void addItemOnClick(View view) {
        try {
            Intent intent = new Intent(MainActivity.this, com.a3.vendorapp.activity.AddItemActivity.class);
